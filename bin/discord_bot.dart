...
void main() async {
  ...
  client.onMessageCreate.listen((event) async {
    ...
    if (content.startsWith('.c')) {
      ...
      final skelliesTotal = skellies * skelliesPrice;
      final moneyTotal = money * moneyPrice;
      final elytraTotal = elytras * elytraPrice;
      final total = skelliesTotal + moneyTotal + elytraTotal;

      final reply = '''
Calculation results:
- Skellies: $skellies × €0.20 = €${skelliesTotal.toStringAsFixed(2)}
- Money (millions): $money × €0.20 = €${moneyTotal.toStringAsFixed(2)}
- Elytras: $elytras × €15.00 = €${elytraTotal.toStringAsFixed(2)}
...
''';
    ...
    // Your existing commands .v and .pp here...
